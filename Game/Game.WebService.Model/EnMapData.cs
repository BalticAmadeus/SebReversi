    ...
    public class EnMapData
    {
        ...
        public MapData ToMapData()
        {
            ...
            if(md.Width != md.Height)
                throw new ApplicationException("Map is not square");

            if (md.Width != 6 && md.Width != 8 && md.Width != 10)
                throw new ApplicationException("Map format not supported");
        ...
        public static char BuildTile(TileType tile)
        {
            switch (tile)
            {
                ...
                //case TileType.Head6:
                //case TileType.Head7:
                    return (char)('0' + (tile - TileType.Player1)); // '0' = char(48)
                //case TileType.Body0:
                //case TileType.Body1:
                //case TileType.Body2:
                //case TileType.Body3:
